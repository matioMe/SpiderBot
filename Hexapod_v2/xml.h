...
public:
    XML(string fileName);
    ~XML();
    int generateFile(float values[], int nbColumn);
...
<Row ss:Height="12,8126"><Cell><Data ss:Type="String">Z pos sur l</Data></Cell><Cell><Data ss:Type="String">Zposition v1</Data></Cell></Row>
<Row ss:Height="12,8126"><Cell><Data ss:Type="Number">0</Data></Cell><Cell><Data ss:Type="Number">0</Data></Cell></Row>
*/
